...
const WalletCard: React.VFC<WalletCardProps> = ({
  ...
  return (
    <li
      className={clsx(
        "relative flex flex-col justify-between w-full h-48 p-8 bg-gray-100 shadow-md border border-gray-200 rounded-xl overflow-hidden before:absolute before:left-0 before:bottom-0 before:w-full before:h-2.5 before:transform before:translate-y-1 before:transition-transform before:ease-in-out before:duration-150 hover:before:translate-y-0 focus:outline-none focus:before:translate-y-0",
    ...
    >
      <div className="flex justify-between">
        ...
        <div className="text-lg text-gray-500 font-finance">
          {numeral(totalAmount).format("0,00.00")} zł
        </div>
      </div>
